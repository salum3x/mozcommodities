<div>
    <!-- Hero Banner -->
    <div class="bg-gradient-to-r from-green-600 via-green-500 to-emerald-500 text-white">
            ...
            <div class="lg:w-64 flex-shrink-0">
                <div class="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="text" wire:model.live.debounce.300ms="search"
                                   class="w-full pl-10 pr-4 py-3 bg-gray-50 border-0 rounded-xl focus:ring-2 focus:ring-green-500 focus:bg-white"
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <button wire:click="clearFilter"
                                    class="w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ $selectedCategory === null ? 'bg-green-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
                            ...
                            @foreach($categories as $category)
                                @if($category->products_count > 0)
                                    <button wire:click="filterByCategory({{ $category->id }})"
                                            class="w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition-all {{ $selectedCategory == $category->id ? 'bg-green-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
                                        <span class="flex items-center justify-between">
                                            {{ $category->name }}
                    ...
                    @if($selectedCategory || $search)
                        <button wire:click="clearFilter"
                                class="w-full mt-6 px-4 py-3 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200 transition-colors">
                            Limpar Filtros
                        </button>
                    @endif
                </div>
