<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <h2 class="text-3xl font-extrabold text-gray-900">Entrar como Cliente</h2>
        <p class="mt-2 text-sm text-gray-600">Acesse sua conta para comprar produtos</p>
    </div>
    ...
    <div class="mt-6 p-4 bg-green-50 rounded-xl border border-green-100">
        <p class="text-sm font-semibold text-green-800 mb-2">Beneficios de ser Cliente:</p>
        <ul class="text-xs text-green-700 space-y-1">
            <li class="flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                </svg>
                Compre produtos agricolas de qualidade
            </li>
            <li class="flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
    ...
    <div class="mt-4 pt-4 border-t border-gray-200 text-center">
        <a href="{{ route('login.supplier') }}" class="inline-flex items-center gap-2 text-sm text-orange-600 hover:text-orange-700 font-medium">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
